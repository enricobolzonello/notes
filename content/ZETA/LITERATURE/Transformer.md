...
Transformer is basically combining [[PARA/PROJECTS/Deep Learning/Sequence to Sequence Architectures#Attention Model|Attention]] with *CNN*. 
...
**Positional Encoding**:
![[images/transformer_posencoding.png]]
